    ...
    <div className="bg-white w-full py-10">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            ...
            <label htmlFor="todo1" className="text-gray-800">Jog around the park</label>
          </div>
          
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            <input type="checkbox" id="todo2"/>
            <label htmlFor="todo2" className="text-gray-800">10 minutes meditation</label>
          </div>
          
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            <input type="checkbox" id="todo3"/>
            <label htmlFor="todo3" className="text-gray-800">Read for 1 hour</label>
          </div>
          
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            <input type="checkbox" id="todo4"/>
            <label htmlFor="todo4" className="text-gray-800">Pick up groceries</label>
          </div>
          
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            <input type="checkbox" id="todo5"/>
            <label htmlFor="todo5" className="text-gray-800">Complete TODO App on Fronted Mentor</label>
          </div>
          <div className="w-[60%] max-w-xl px-4 py-2 rounded-full shadow-md flex items-center gap-2">
            <input type="checkbox" id="todo5"/>
            <label htmlFor="todo5" className="text-gray-800">Complete TODO App on Fronted Mentor</label>
